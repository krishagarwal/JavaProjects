...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTesting StackedQueue...");

        StackedQueue<Integer> stackedQueue = new StackedQueue<>(5, 1, 2, 3, 4);
        System.out.println("First element in initial stackedQueue with max length of " + stackedQueue.getMAX_LENGTH() + ": " + stackedQueue.dequeue());

        System.out.println("Is stackedQueue empty: " + stackedQueue.isEmpty());

        System.out.println("First element in stackedQueue after dequeuing: " + stackedQueue.peek());

        stackedQueue.enqueue(5);
        System.out.println("First element in stackedQueue after enqueuing 5: " + stackedQueue.peek());

        System.out.println("Queue length: " + stackedQueue.length());

        stackedQueue.enqueue(6);
        System.out.println("Is stackedQueue full after enqueuing: " + stackedQueue.isFull());

        stackedQueue.offer(7);
        System.out.println("This message indicates that a QueueOverFlowException was not thrown while offering a value to a full stackedQueue.");
