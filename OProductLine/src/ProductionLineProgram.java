	...
	//public static void main(String[] args) {		
		...
		do {
	        ...
	        case "1":
	        	...
	        	switch (submenuchoice) {
			        ...
			        case "2":
			        	...
			        	quantity = input.nextInt();
			        	for (int i = 1; i<quantity;i++) {
			        		allproducts.add(new MoviePlayer(newproduct.getName(),((MoviePlayer)newproduct).getScreen(),((MoviePlayer)newproduct).getMonitor()));
			        	}
			        	break;		           
	        	}
	        ...
	        case "2":
	        	...
	        	Set<Product> uniqueproduct = new HashSet<Product>(allproducts);
